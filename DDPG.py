...
parser.add_argument('--tau',  default=0.5, type=float) # target smoothing coefficient
parser.add_argument('--target_update_interval', default=1, type=int)
parser.add_argument('--test_iteration', default=10, type=int)

parser.add_argument('--learning_rate', default=1, type=float)
parser.add_argument('--gamma', default=0.9, type=float) # discounted factor
...
parser.add_argument('--max_episode', default=10, type=int) # num of games
...
class SMCenv(gym.Env):
    ...
    def reset(self):
        ...
        self.am = 0
        self.R = 10
        return np.array([self.x1, self.x2], dtype=np.float64)
    ...
    def step(self, action):
        ...
        next_state = np.array([self.x1, self.x2], dtype=np.float64)
...
def main():
    ...
    if args.mode == 'test':
        agent.load()
        for i in tqdm(range(args.test_iteration)):
            state = env.reset()
            for t in count():
